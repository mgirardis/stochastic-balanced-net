...
#SBATCH -N 1-3
#SBATCH --array=51,53,54,56,57,107,108,110-113       # indices of the lines from lines_to_run.txt to be executed

module load py36-brian2/2.2.2.1

LINE=$(sed -n "$SLURM_ARRAY_TASK_ID"p lines_to_run_smalltau.txt)
