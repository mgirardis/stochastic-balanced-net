...
def main():
    ...
    #sys.argv = 'PhaseTransGLNetEI.py -p 1.0 -saveTimeEvo -parName rPoisson -parVal1 0.000001 -parVal2 1.0 -nPar 5 -parScale log -mu 0.0 -Gamma 0.2 -J 5.0 -Y 1.0 -theta 1.0 -N 1000 -simType static -tTotal 10000 -tTrans 3000 -outputFile run/output/glexc_pt_poisson_G0.2_J5.0_Y1_N1000.mat -nNeuSpikingData 1000'.split(' ')
