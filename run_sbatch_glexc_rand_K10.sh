...
#SBATCH -J K10         # Job name
#SBATCH -o run/out/K10_%A_%a.out    # Name of stdout output file (%j expands to %jobID)
#SBATCH -e run/err/K10_%A_%a.err    # Name of stdout output file (%j expands to %jobID)
